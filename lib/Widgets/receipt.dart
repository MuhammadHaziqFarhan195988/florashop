...
class Receipt extends StatelessWidget {
  ...
  Receipt({Key? key, required this.orderID,}) : super(key: key);
                ...
                child: Column(
                  children: [
                    ...
                    FutureBuilder<DocumentSnapshot>(future: EcommerceApp.firestore!.collection(EcommerceApp.collectionUser).doc(EcommerceApp.sharedPreferences!.getString(EcommerceApp.userUID))
                      ...
                      builder: (c, snap){
                        return snap.hasData ? ShippingDetails(model: AddressModel.fromJson(snap.data!.data as Map<String, dynamic>),) : Center(
