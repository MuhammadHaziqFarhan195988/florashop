...
class DoneOrdered extends StatelessWidget {
  ...
  DoneOrdered({Key key, this.itemCount, this.data, this.orderID}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  InkWell(
      ...
      child: Container(
        ...
        child: ListView.builder(itemBuilder: (c, index){ItemModel model = ItemModel.fromJson(data[index].data);
