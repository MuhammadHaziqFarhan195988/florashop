  ...
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.all(Radius.circular(20.0))
        ,boxShadow: <BoxShadow>[
          BoxShadow(offset: Offset(0, 5), blurRadius: 10.0, color: const Color.fromRGBO(238, 238, 238, 1)),
    ]
    ),
    child: ClipRRect(
      borderRadius: BorderRadius.all(Radius.circular(20.0)),
...
addItemToCart(String shortInfoAs, BuildContext context){
 List<String>? tempoCartList = EcommerceApp.sharedPreferences!.getStringList(EcommerceApp.userCartList);
 ...
 .update({EcommerceApp.userCartList: tempoCartList, }).then((value) {
